		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Maintain Flight",
									"targetURL": "#micpurfioriapp01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"micpurfioriapp01-display": {
								"semanticObject": "micpurfioriapp01",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mic.pur.fioriapp01",
									"url": sap.ui.require.toUrl("mic/pur/fioriapp01")
								}
							}
						}
					}
